...
function! nerdcommenter#comment_insert()
...
function! nerdcommenter#comment_bar(fill, nfill, suffix) " inserts above by default; most common use
  let cchar = Comment()
...
function! nerdcommenter#comment_bar_surround(fill, nfill, suffix)
  let cchar = Comment()
  let nspace = s:comment_indent()
  let suffix = (a:suffix ? cchar : '')
  let nfill = (a:nfill - nspace)/len(a:fill) " divide by length of fill character
...
function! nerdcommenter#comment_inline(ndash)
  let nspace = s:comment_indent()
  let cchar = Comment()
  normal! k
...
function! nerdcommenter#comment_double()
  let nspace = s:comment_indent()
  let cchar = Comment()
  normal! k
...
function! nerdcommenter#comment_message(message)
  let nspace = s:comment_indent()
  let cchar = Comment()
  normal! k
...
" Docstring
function! nerdcommenter#insert_docstring(char)
