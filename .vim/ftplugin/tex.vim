...
noremap <silent> <buffer> <C-z> :w<CR>:exec('!clear; set -x; document '.shellescape(@%).' false false')<CR>
noremap <silent> <buffer> <Leader>z :w<CR>:exec('!clear; set -x; document '.shellescape(@%).' true  false')<CR>
