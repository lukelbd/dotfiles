...
" " Email:      karl.yngve@gmail.com
" "
" " Must, for whatever reason, be in the **after** folder; this is
" " only a modification of the defaults.
"
" if !exists('b:current_syntax')
"   let b:current_syntax = 'tex'
" elseif b:current_syntax !=# 'tex'
...
" "        \]
" "  for [style, group, commands] in [
" "        \ ['texItalStyle', 'texItalGroup', ['prob', 'Prob', 'section']],
" "        \ ['texBoldStyle', 'texBoldGroup', ['subprob', 'Subprob', 'subsection', 'subsubsection']]
" "        \]
" " CUSTOM EDITED by Luke Davis: Feb 13, 2017
"   for [style, group, commands] in [
"         \ ['texItalStyle', 'texItalGroup', ['prob', 'Prob', 'section', 'subsection', 'subsubsection', 'subprob', 'Subprob']],
"         \ ['texBoldStyle', 'texBoldGroup', ['emph', 'textit', 'textbf']]
"         \]
"     for cmd in commands
