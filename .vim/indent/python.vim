...
function! GetPythonIndent(lnum)
  ...
  if plnum == 0  " this is the first non-empty line, use zero indent.
    return 0
  endif
  call cursor(plnum, 1)
  ...
  if disable_parentheses_indenting == 1
    ...
    " If previous line is inside parenthesis, use the indent of the starting line.
  ...
  if has('syntax_items')
    " If the last character in the line is a comment, do a binary search for the
    " start of the comment. synID() is slow, a linear search would take too long
