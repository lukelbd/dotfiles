...
#   For the settings see: https://github.com/python-lsp/python-lsp-server and for an
#   example json file see: https://github.com/jupyter-lsp/jupyterlab-lsp/issues/818.
